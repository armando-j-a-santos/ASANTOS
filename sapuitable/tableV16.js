(function() {
    ...
    class sapuitableV16 extends HTMLElement {
    ...
    customElements.define("com-asantos-sap-sac-sapuitable", sapuitableV16);
                ...
                return Controller.extend("myView.Template", {
                    ...
                    onInit: function() {
                        ...
                        /////} else {
                            ...
                            this.getView()
                                .setModel(selOrgJson, that.widgetName);

                            sap.ui.getCore().setModel(selOrgJson, that.widgetName);
                        /////}
                    },
